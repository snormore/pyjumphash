/* Generated by Cython 0.20.2 on Wed Aug 13 23:30:34 2014 */
...
#endif
#include <math.h>
#define __PYX_HAVE__jumphash__hasher
#define __PYX_HAVE_API__jumphash__hasher
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'jumphash.hasher' */
#define __Pyx_MODULE_NAME "jumphash.hasher"
int __pyx_module_is_main_jumphash__hasher = 0;

/* Implementation of 'jumphash.hasher' */
static char __pyx_k_main[] = "__main__";
static char __pyx_k_test[] = "__test__";
static PyObject *__pyx_n_s_main;
static PyObject *__pyx_n_s_test;
static PyObject *__pyx_int_1;
static PyObject *__pyx_int_2862933555777941757;

/* "jumphash/hasher.pyx":2
 * 
...
static long __pyx_f_8jumphash_6hasher_jumphash(int __pyx_v_N, long __pyx_v_key) {
  int __pyx_v_b;
  int __pyx_v_j;
  double __pyx_v_d1;
  double __pyx_v_d2;
 ...
 */
    ...
    __pyx_t_3 = PyNumber_Multiply(__pyx_t_2, __pyx_int_2862933555777941757); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
    ...
    __pyx_v_d2 = (__pyx_v_d2 / __pyx_t_4);

    /* "jumphash/hasher.pyx":12
 *         d2 = 1L << 31
 *         d2 /= (key >> 33) + 1
 *         j = int(d1 * d2)             # <<<<<<<<<<<<<<
 *         # j = double(b+1) * (double(1L << 31) / double((key >> 33) + 1))
 *     return b
 */
    __pyx_v_j = ((int)(__pyx_v_d1 * __pyx_v_d2));
  }

  /* "jumphash/hasher.pyx":14
 *         j = int(d1 * d2)
 *         # j = double(b+1) * (double(1L << 31) / double((key >> 33) + 1))
 *     return b             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_WriteUnraisable("jumphash.hasher.jumphash", __pyx_clineno, __pyx_lineno, __pyx_filename, 0);
  __pyx_r = 0;
  __pyx_L0:;
...
static int __Pyx_InitGlobals(void) {
  ...
  __pyx_int_2862933555777941757 = PyInt_FromString((char *)"2862933555777941757", 0, 0); if (unlikely(!__pyx_int_2862933555777941757)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  return 0;
  __pyx_L1_error:;
  return -1;
}
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC inithasher(void); /*proto*/
PyMODINIT_FUNC inithasher(void)
#else
PyMODINIT_FUNC PyInit_hasher(void); /*proto*/
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_hasher(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("hasher"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_jumphash__hasher) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "jumphash.hasher")) {
      if (unlikely(PyDict_SetItemString(modules, "jumphash.hasher", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 2; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    __Pyx_AddTraceback("init jumphash.hasher", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init jumphash.hasher");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
